        ...
        private void askQuestion(int qnum)
        {
            switch (qnum)
            {
                case 1:
                    ...
                    lblQuestion.Text = "What is the definition of Education for Sustainable Development?"; // 125 characters right now:::
                ...
                case 7:
                    ...
                    lblQuestion.Text = "Which country is top in Europe for recycling?";
                    button1.Text = "Denmark";
                    button2.Text = "Italy";
                    button3.Text = "Germany";
                    button4.Text = "Belgium";
                    correctAnswer = 3;
                    break;
                case 8:
                    pictureBox1.Image = Properties.Resources.questions;
